...
for i in *.md; do
  [ -f "$i" ] || break
  pandoc $i --template=../../../../common/templates/assignment_template.latex --top-level-division=section --pdf-engine=xelatex --listings -o ../../../production/assignments/solutions/${i%%.*}.pdf
done
