...
Befor("(@notused or @important) and @alsonotused") {
    throw new RuntimeException("Never Happens")
}

// Register step definition using Groovy syntax for regex patterns.
// If you use slashes to quote your regexes, you don't have to excape backslashes
...
// The expected value in the step is converted to the rerquired type.
