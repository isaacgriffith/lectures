...
\begin{example}
\begin{center}
\includegraphics[width=.25\textwidth]{images/Testing/Mutation/ior_ex.eps}
\end{center}
\end{example}
...
\begin{example}
\begin{center}
\includegraphics[width=.175\textwidth]{images/Testing/Mutation/isi_ex.eps}
\end{center}
\end{example}
...
\begin{example}
\begin{center}
\includegraphics[width=.195\textwidth]{images/Testing/Mutation/isd_ex.eps}
\end{center}
\end{example}
...
\begin{example}
\begin{center}
\includegraphics[width=.225\textwidth]{images/Testing/Mutation/ipc_ex.eps}
\end{center}
\end{example}
...
\begin{example}
\begin{center}
\includegraphics[width=.215\textwidth]{images/Testing/Mutation/jti_ex.eps}
\end{center}
\end{example}
...
\begin{example}
\begin{center}
\includegraphics[width=.215\textwidth]{images/Testing/Mutation/jtd_ex.eps}
\end{center}
\end{example}
